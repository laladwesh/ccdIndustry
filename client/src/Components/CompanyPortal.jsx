  ...
  const fetchAllCompanies = async () => {
    try {
      const Response = await fetch(
        process.env.REACT_APP_API_BASE_URI + "/api/get-all-companies",
        {
          method: "POST",
          headers: {
...
function Company({ name, profiles, pocs, id, setCompanies, userRole }) {
  ...
  const updatePOCStatus = async (pocId, status) => {
    ...
    try {
      const response = await fetch(
        process.env.REACT_APP_API_BASE_URI + "/api/update-poc-status",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const updatePOCRemark = async (pocId, remarks) => {
    ...
    try {
      const response = await fetch(
        process.env.REACT_APP_API_BASE_URI + "/api/update-poc-remarks",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDeleteCompany = async () => {
    ...
    try {
      const response = await fetch(
        process.env.REACT_APP_API_BASE_URI + "/api/delete-company",
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
